...
while($row1= $result1->fetch_assoc()){ ?>			  
		...
		<!-- I echoed here-->		<?php	 echo  $row1["name"]; ?>
						        	</a>
						      	</h4>
						    </div>
...
<?php
//if(!empty($_SESSION["category"])){ //this value serves as an indicator from JavaScript that the client clicked on a category to view.
//$queury ="Select";
...
<!-- I echoed here -->						<h4><a href="product-single.html">
							<?php
								//echo row["name"];
							?>
						</a></h4>
